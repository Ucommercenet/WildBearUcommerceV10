...
namespace ConsoleAppForTraceTest
{
    public static class SimulateWorkload
    {
        ...
        {
            ConsoleEventSource.Log.Start("Calculating prime numbers");
            ...
            ConsoleEventSource.Log.Finished("Finished calculating prime numbers");
            return primes;
        }
        ...
        public static List<int> CalculateSuperPrimes(List<int> primes)
        {
            ...
            for (int i = 0; i < primes.Count; i++)
            {
                ...
                if (IsPrimeOptimized(primePosition))
                {
                    ...
                    ConsoleEventSource.Log.FoundSuperPrimeNumber(superPrime, primePosition);
